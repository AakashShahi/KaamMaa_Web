            ...
            <div className="flex items-center gap-4 relative">
                ...
                >
                    ...
                    <div className="hidden sm:flex flex-col text-left">
                        ...
                        <span className="text-xs text-gray-500">admin@kaammaa.com</span>
                    </div>
                </button>
                ...
                {showProfileMenu && (
                    <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-md shadow-lg z-50">
                        ...
                        <button className="w-full flex items-center gap-2 px-4 py-2 text-left hover:bg-red-100 text-red-600 font-Inter">
                            <LogOut size={18} />
                            Sign Out
                        </button>
                    </div>
